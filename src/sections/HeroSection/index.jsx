...
export default function HeroSection() {
  return (
    <section className="hero-section min-h-screen w-full flex items-center justify-center px-5 sm:px-8 bg-[var(--bg)]">
      <div className="hero-content mx-auto flex w-full max-w-[min(700px,calc(100vw-40px))] max-h-[calc(100vh-8vh)] flex-col justify-center overflow-hidden px-5 py-16 text-center">
        ...
        <div className="save mb-7 text-[2.4rem] opacity-95 save-font text-[var(--primary)]">
          Save the date
        </div>
        ...
        <p className="info mx-auto mb-2 w-full max-w-[32rem] text-center text-[1.125rem] leading-[1.7] text-[var(--text)] info-font">
          Join us on the 10<sup>th</sup> of October 2026
        </p>
        <p className="location mx-auto mb-9 w-full max-w-[32rem] text-center text-[1.125rem] leading-[1.7] text-[var(--text)] info-font">
          Athens, Greece
        </p>
